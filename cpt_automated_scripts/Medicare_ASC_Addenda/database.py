...
class SupabaseHandlerASC:
    """Handle Supabase database operations for the ASC table with historical archival"""
    ...
    def __init__(self):
        ...
        self.script_name = "Medicare ASC Addenda"
        self.data_type = "Medicare Facility"
